/*
 ...
 The complete DB schema is under willyfog-api repository.
 https://github.com/popokis/willyfog-api
 */
...
CREATE TABLE oauth_authorization_codes (authorization_code VARCHAR(40) NOT NULL, client_id VARCHAR(80) NOT NULL, user_id VARCHAR(255), redirect_uri VARCHAR(2000), expires TIMESTAMP NOT NULL, scope VARCHAR(2000), id_token VARCHAR(2000), CONSTRAINT auth_code_pk PRIMARY KEY (authorization_code));
...
INSERT INTO oauth_clients (client_id, redirect_uri, grant_types) VALUES ('testclient', 'http://192.168.33.10/login/callback', 'authorization_code');
